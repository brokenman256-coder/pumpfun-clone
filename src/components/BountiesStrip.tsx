const BOUNTIES = [
  ...
  },
  {
    ...
    reward: '$5,620',
    left: '3d left',
    img: 'https://api.dicebear.com/7.x/shapes/svg?seed=bounty2&backgroundColor=3b82f6',
  },
  {
  ...
  return (
    <section className="mb-5">
      ...
      <div className="no-scrollbar flex gap-3 overflow-x-auto pb-1">
        {BOUNTIES.map((b) => (
          <article key={b.title} className="w-[260px] shrink-0 overflow-hidden rounded-2xl border border-[#1e293b] bg-[#111827]">
            <div className="relative h-28">
              <img src={b.img} alt="" className="h-full w-full object-cover" />
              <span className="absolute left-2 top-2 rounded-md bg-[#3b82f6] px-1.5 py-0.5 text-[10px] font-bold text-white">
                OPEN
              </span>
            </div>
            <div className="p-3">
